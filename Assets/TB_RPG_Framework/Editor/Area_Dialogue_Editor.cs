...
//			multipleTransitions = serializedObject.FindProperty ("multipleTransitions");
		...
		public override void OnInspectorGUI(){
			...
			EditorGUILayout.PropertyField(inactiveTime, new GUIContent("Inactive Time", "The amount of seconds that dictate how long before the dialogue can be displayed again after it has been completed/destroyed."));
			// Decrease the indent.
			EditorGUI.indentLevel--;
