...
//		// The transition notifiers.
//		private bool isUITransIn = false;
//		private bool isUITransOut = false;
//		private bool isTextTransIn = false;
//		private bool isTextTransOut = false;
//
//
//		void Awake(){
...
//			if (isInTransition) {
//				// STOP EVERYTHING COROUTINE BASED.
//				StopAllCoroutines ();
//
//				// Skip our transition as the Player doesnt want to wait.
//				SkipTransition ();
//			
...
//					chara.CanMove = false;
//					// Let everything know that this GameObject has a running dialogue.
...
//			// IF our UI is currently transitioning in. (Set UI + Text)
//			if (isUITransIn) {
//				// Finish all the UI and Text for skipping.
//				SetFullUITextIn ();
...
//			}
//
//			// IF our UI is transitioning out. (At the end)
//			if (isUITransOut) {
//				// Set the UI and the Text to not show.
//				SetFullUITextOut ();
//				// We are done transitioning out.
//				isUITransOut = false;
//				isTextTransOut = false;
//				// Reset the Dialogue.
//				ResetDialogue ();
//				return;
//			}
//
//			// IF our text is transitioning in. (Set full text)
//			// ELSE IF our text is transitioning out. (Text is changing + Set full text)
//			if (isTextTransIn) {
//				// Finish all the Text for skipping.
//				SetFullTextIn ();
//				// Increase the dialogueIndex.
//				dialogueIndex++;
//				// We are done transitioning in.
//				isTextTransIn = false;
//			} else if (isTextTransOut) {
//				// Increase the dialogueIndex so the new dialogue can be shown.
//				dialogueIndex++;
//				// Finish all the text for skipping
//				SetFullTextIn ();
//				// We are done transitioning out.
...
//			// ELSE IF we want the text to by instantly displayed.
//			if(fadeText){
//				dialogueComponent.SetDialogueTextAlpha(0f);
//			} else if(typedText){
//				// Set the initial alpha of the text to what the developer had before runtime.
...
//			// IF a Character script exists.
//			if(chara != null){
//				// Make this GameObject be able to move.
//				chara.CanMove = true;
