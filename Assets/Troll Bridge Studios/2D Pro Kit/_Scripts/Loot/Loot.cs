...
namespace TrollBridge {
	...
	/// <summary>
	/// Loot handles tossing out gameobjects which are our items for when we call DeathDrop () method.
	/// </summary>
	public class Loot : MonoBehaviour {
		...
		private void DropItem(GameObject loot){
			// Spawn the drop.
			GameObject item = Instantiate (loot, GetComponentInParent<Character> ().characterEntity.transform.position, Quaternion.identity) as GameObject;
