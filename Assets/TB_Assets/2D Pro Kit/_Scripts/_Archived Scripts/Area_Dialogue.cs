...
//		public bool multipleTransitions = false;
		...
		void OnTriggerExit2D(Collider2D coll){
			...
			characterManager.ListOfAreaDialogues.Remove (this);
...
//				return;
//			}
			// IF we currently have a dialogue running.
			if (!isFinished) {
				return;
			}
